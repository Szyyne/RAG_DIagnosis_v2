...
> **OpenEnv v0.2.2 RL environment** for training LLMs to diagnose root causes in broken RAG pipelines and emit config patches — scored on diagnosis quality, fix correctness, and downstream faithfulness.
...
| Deliverable | Link |
|---|---|
| 🤗 **HuggingFace Space** (live demo) | [spaces/YOUR_USERNAME/rag-diagnostic-gym](https://huggingface.co/spaces/YOUR_USERNAME/rag-diagnostic-gym) |
| 📓 **Training Notebook** (Colab) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/YOUR_USERNAME/rag-diagnostic-gym/blob/main/notebooks/train_colab.ipynb) |
| 📝 **Writeup / Blog** | [HuggingFace Blog Post](https://huggingface.co/blog/YOUR_USERNAME/rag-diagnostic-gym) |
| 🎥 **Demo Video** | [YouTube (< 2 min)](https://youtube.com/YOUR_VIDEO_LINK) |
| 📦 **GitHub Repo** | [github.com/YOUR_USERNAME/rag-diagnostic-gym](https://github.com/YOUR_USERNAME/rag-diagnostic-gym) |
